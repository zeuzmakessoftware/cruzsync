...
export const ROUTE_META: Record<string, { shortName: string; longName: string; color: string }> = {
  '35': { shortName: '35', longName: 'Highway 9/Scotts Valley', color: '#0f5c8c' },
  '11': { shortName: '11', longName: 'UCSC via West Gate - High', color: '#c2541c' },
  '18': { shortName: '18', longName: 'UCSC via Main Gate - Mission', color: '#2f6f4f' },
  '19': { shortName: '19', longName: 'UCSC via West Gate - Bay', color: '#7b3f8f' },
};
...
export function findCampusDestination(key: string): CampusDestination | undefined {
